...
trigger1 = (command = "holdback" && (Map(xy) || Map(z))) || (StateType != A && Map(BB))
...
triggerall = stateno != 100
triggerall = stateno != 112
trigger1 = (Map(xy) || Map(z)) || (StateType != A && Map(FF))
trigger1 = statetype = S && ctrl
...
trigger1 = (Map(xy)|| Map(z)) || (StateType != S && Map(FF))
trigger1 = statetype = A && ctrl
...
value = 910
triggerall = roundstate = 2 && !var(59)
trigger1 = Map(b) && (command = "holdfwd" || command = "holdback")
trigger1 = p2bodydist x < 18 && enemynear,movetype != H
trigger1 = statetype = S && ctrl
...
value = 200
triggerall = roundstate = 2 && !var(59)
triggerall = Map(x) && command != "holddown"
trigger1 = statetype = S && ctrl
trigger2 = stateno = 101 && prevstateno != 810
...
value = 210
triggerall = roundstate = 2 && !var(59)
triggerall = Map(y) && command = "holddown"
...
value = 240
triggerall = roundstate = 2 && !var(59)
triggerall = Map(a) && command != "holddown"
trigger1 = statetype = S && ctrl
trigger2 = stateno = 101 && prevstateno != 810
trigger3 = stateno = 200 && movecontact
trigger4 = stateno = 230 && movecontact
...
value = 250
triggerall = roundstate = 2 && !var(59)
triggerall = Map(b) && command != "holddown"
trigger1 = statetype = S && ctrl
trigger2 = stateno = 101 && prevstateno != 810
trigger3 = stateno = 200 && movecontact
trigger4 = stateno = 210 && movecontact
...
value = 430
triggerall = roundstate = 2 && !var(59)
triggerall = Map(a) && command = "holddown" && command != "holdfwd"
trigger1 = statetype = C && ctrl
...
trigger6 = stateno = 641 && movecontact
