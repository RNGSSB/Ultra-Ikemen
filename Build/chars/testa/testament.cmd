...
type = changestate
trigger1 = ishelper
trigger1 = ishelper(5091)
trigger1 = stateno != 5091
value = 5091
...
trigger1 = time = [22+(var(58)=2)*2,27+(var(58)=2)*2]
trigger2 = stateno = 1200 || stateno = 1240
trigger2 = time = [12,15]
...
trigger4 = time = [16,18]
trigger5 = var(58)=2
trigger5 = stateno = 3180
trigger5 = animelemtime(15) >= 0
trigger5 = animelemtime(15) <= 2
trigger6 = stateno = 1220 || stateno = 1245
trigger6 = time = [14,16]
ignorehitpause = 1
...
triggerall = var(40) = 0
triggerall = power >= 1000
triggerall = command = "ナイトメアサーキュラーS"
trigger1 = statetype != A
trigger1 = (ctrl||fvar(28))
trigger2 = var(3) = 0
trigger2 = (stateno = [200,451]) && (movecontact||movereversed)
trigger2 = stateno != [235,240]
...
triggerall = var(40) = 0
triggerall = power >= 1000
triggerall = command = "ナイトメアサーキュラー"
trigger1 = statetype != A
trigger1 = (ctrl||fvar(28))
trigger2 = var(3) = 0
trigger2 = (stateno = [200,451]) && (movecontact||movereversed)
...
[State -1]
type = ChangeState
value = ifelse(var(58)=1&&var(42),1240,1200)
triggerall = !ishelper
triggerall = var(59) <= 0
triggerall = var(43) != 1
triggerall = command = "エグゼビースト"
trigger1 = statetype != A
trigger1 = (ctrl||fvar(28))
trigger2 = var(3) = 0
trigger2 = (stateno = [200,451]) && (movecontact||movereversed)
...
[State -1]
type = ChangeState
value = ifelse(var(42),1245,1220)
triggerall = !ishelper
triggerall = var(59) <= 0
triggerall = var(58) = 1
triggerall = var(43) != 1
triggerall = command = "エグゼビースト_HS"
trigger1 = statetype != A
...
triggerall = var(59) <= 0
triggerall = var(58) = 0
triggerall = command = "バッドランズ"
trigger1 = statetype = A
trigger1 = (ctrl||fvar(28))
trigger2 = (stateno = [600,650]) && (movecontact||movereversed || var(29)) && var(3) = 0
trigger3 = (stateno = 110 && time >= 6) || (stateno = 115 && time >= 5)
...
[State -1];特殊ディガー
type = ChangeState
value = ifelse(var(58)=2,1850,1150)
triggerall = !ishelper
triggerall = var(59) <= 0
triggerall = command = "グレイヴディガー"
trigger1 = stateno = [40,41]
trigger1 = animtime = 0
...
[State -1]
type = ChangeState
value = ifelse(var(58)=2,1800,1100)
triggerall = !ishelper
triggerall = var(59) <= 0
triggerall = command = "グレイヴディガー"
trigger1 = statetype != A
...
triggerall = !ishelper
triggerall = var(59) <= 0
triggerall = (var(48) = 0 && var(30) = 0) || var(58) = 2
triggerall = command = "ファントムソウル_P"
trigger1 = statetype != A
trigger1 = (ctrl||fvar(28))
trigger2 = var(3) = 0
trigger2 = (stateno = [200,451]) && (movecontact||movereversed)
...
trigger1 = stateno = 200||stateno = 210||(stateno = [220,225])||(stateno = [400,430])
...
trigger5 = var(29)
trigger5 = stateno = 200||stateno = 210||(stateno = [220,225])||(stateno = [400,430])
...
triggerall = command = "z"
triggerall = var(3) = 0
trigger1 = (stateno = [200,215])||stateno = 220||(stateno = [400,420])
trigger1 = (movecontact||movereversed)
...
trigger5 = (stateno = [200,215])||stateno = 220||(stateno = [400,420])
trigger5 = var(29)
...
triggerall = var(3) = 0
trigger1 = (stateno = [200, 210])||(stateno = [220, 225])
trigger1 = (movecontact||movereversed)
...
triggerall = var(59) <= 0
triggerall = command = "y"
triggerall = p2bodydist X=[-52,54]
triggerall = var(3) = 0
trigger1 = stateno = 200||stateno = 205||stateno = 210
trigger1 = (movecontact||movereversed)
trigger2 = stateno = 400||stateno = 410
trigger2 = (movecontact||movereversed)
...
triggerall = command = "y"
triggerall = var(3) = 0
trigger1 = p2bodydist X > 54 || p2bodydist X < -54
trigger1 = stateno = 200||stateno = 205||stateno = 210
trigger1 = (movecontact||movereversed)
trigger2 = p2bodydist X > 54 || p2bodydist X < -54
trigger2 = stateno = 400||stateno = 410
trigger2 = (movecontact||movereversed)
...
triggerall = command = "y"
triggerall = command != "holddown"
triggerall = p2bodydist X > 54 || p2bodydist X < -54
trigger1 = statetype = S
trigger1 = (ctrl||fvar(28))
trigger2 = stateno = [100, 101]
trigger3 = stateno = [195, 197]
...
triggerall = var(3) = 0
trigger1 = stateno = 200||(stateno = [210,225])||(stateno = [400,420])
trigger1 = (movecontact||movereversed)
...
trigger1 = statetype = S
trigger1 = (ctrl||fvar(28))
trigger2 = (stateno = [200,205])||stateno = 215
trigger2 = (movecontact||movereversed) && var(3) = 0
...
triggerall = command = "b"
triggerall = var(3) = 0
trigger1 = (stateno = [200,225])||stateno = 400||stateno = 420
trigger1 = (movecontact||movereversed)
...
trigger5 = time > ifelse(anim = 195,64,18)
;---------------------------------------------------------------------------
[State -1, Taunt]
type = ChangeState
value = 195
...
triggerall = helper(2000),stateno != [2200,2299]
...
trigger4 = stateno = 101
trigger5 = stateno = 40 || stateno = 52
trigger6 = stateno = 196
trigger6 = time > ifelse(anim = 195,64,18)
...
trigger4 = numhelper(780+id)
trigger4 = helper(780+id),sysvar(0)
trigger4 = (stateno = [200,236]) && (movecontact||movereversed||fvar(28))

trigger5 = numhelper(780+id)
trigger5 = helper(780+id),sysvar(0)
trigger5 = (stateno = [400,450]) && (movecontact||movereversed||fvar(28))
...
triggerall = pos y <= ifelse(vel y < 0,-40,-10) || helper(780+id),sysvar(0)
